...
import { ArrowRight, Star, Heart, ShoppingBag, TrendingUp, Crown, Gem, Palette } from 'lucide-react'
              ...
              return (
                ...
                >
                  <Card className="p-8 h-full">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-gold-500 to-gold-600 rounded-2xl mb-6">
