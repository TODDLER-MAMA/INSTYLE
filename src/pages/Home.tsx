...
const Home: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/1454188/pexels-photo-1454188.jpeg?auto=compress&cs=tinysrgb&w=600",
  ...
  const services = [
    {
      ...
      title: "Free Delivery",
      description:
        "Complimentary delivery on orders over ৳2000 across Bangladesh",
      image:
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Move your cursor over our brand name to experience the
                interactive magic that defines our commitment to exceptional
          ...
          >
            <div className="max-w-2xl mx-auto">
              <p className="text-gray-600 leading-relaxed mb-8">
                Our interactive brand experience reflects our dedication to
                creating memorable moments. Just like our products, every detail
                is crafted with precision and care to deliver something truly
                extraordinary.
              </p>
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Explore our carefully curated collections designed to enhance
                ...
                <Link to={category.href} className="block">
                  <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden group-hover:-translate-y-2">
                    ...
                    <div className="relative h-48 overflow-hidden">
                      ...
                      {/* Gradient Overlay */}
                      <div
                        className={`absolute inset-0 bg-gradient-to-t ${category.gradient} opacity-80`}
                      ></div>
                    ...
                    {/* Content Section */}
                    <div
                      className={`relative bg-gradient-to-br ${category.bgGradient} p-6`}
                    >
        ...
        <div className="mb-8 text-center">
          ...
          >
            ...
            <p className="text-gray-300 max-w-xl mx-auto text-sm">
              Discover premium fashion and beauty brands in our carefully
              curated selection.
            </p>
          </motion.div>
        </div>
      ...
      <section className="relative py-16 bg-gradient-to-r from-white to-gold-50/50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Handpicked items that represent the finest in fashion, jewelry,
              and beauty.
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We provide exceptional services and facilities to ensure your
                shopping experience is nothing short of perfect.
              </p>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience our premium facilities designed to provide you with
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Experience our products in person at our flagship store in
                Dhaka, or reach out to us for any inquiries.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                title: "Visit Us",
                details: [
                  "Shop 318, 3rd floor, Rakeen commercial complex",
                  "Rakeen city, mirpur 13",
                  "Open 10 AM - 10 PM"
                ]
              },
              {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Discover what makes In Style BD the premier destination for
                fashion, jewelry, and beauty in Bangladesh.
              </p>
            </motion.div>
          </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${feature.gradient} rounded-xl mb-6 mx-auto`}
                    >
                      <IconComponent className="w-8 h-8 text-white" />
                    </div>
