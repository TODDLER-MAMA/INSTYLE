/*
  ...
  1. New Tables
    - `products` - Main product information with categories, pricing, and metadata
    - `product_variants` - Product variations (size, color, material) with individual pricing and stock
    - `product_images` - Product image gallery with display order and primary image designation
  
  2. Security
    - Enable RLS on all new tables
    - Public can read active products and their variants/images
    - Only admin (instylebd86@gmail.com) can manage products, variants, and images
    - Updated policies for orders and profiles tables
  
  3. Features
    - Complete product catalog with variants and images
    - Proper indexing for performance
    - Automatic timestamp updates
    - Sample data for testing
*/

-- Create function to get current user email safely
