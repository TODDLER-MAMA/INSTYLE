/*
  ...
  1. New Tables
    - `products` - Main product information with categories and pricing
    - `product_variants` - Product variations (size, color, material, etc.)
    - `product_images` - Product image management with ordering
  ...
  3. Features
    - Support for multiple product variants per product
    - Image management with primary/secondary designation
