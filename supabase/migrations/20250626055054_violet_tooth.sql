/*
  ...
  1. New Tables
    ...
    - `product_variants` table for size, color, material variations
    - `product_images` table for multiple product images
...
-- Create helper function to get user email from JWT (if not exists)
